...
templates['book-result'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"post\" data-isbn="
    ...
    + "</p>\r\n    </div>\r\n  </div>\r\n  <div class=\"book-count\" data-count="
    + alias4(((helper = (helper = helpers.bookCount || (depth0 != null ? depth0.bookCount : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"bookCount","hash":{},"data":data,"loc":{"start":{"line":15,"column":37},"end":{"line":15,"column":50}}}) : helper)))
    + ">\r\n    "
    + alias4(((helper = (helper = helpers.bookCount || (depth0 != null ? depth0.bookCount : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"bookCount","hash":{},"data":data,"loc":{"start":{"line":16,"column":4},"end":{"line":16,"column":17}}}) : helper)))
    + " Books Available\r\n  </div>\r\n\r\n</div>";
},"useData":true});
